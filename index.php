...
$background = [
    [
        ...
        'period_start' => 'Jan 2015',
        'period_finish' => 'Current',
    ...
    [
        ...
        'period_start' => 'Mar 2012',
        'period_finish' => 'Dec 2014',
    ...
    [
        ...
        'period_start' => 'Jun 2010',
        'period_finish' => 'Mar 2012',
        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
            <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Опыт работы</h2>
                <?php for ($i = 0; $i < count($background); $i++):?>
                     <div class="w3-container">
                          <h5 class="w3-opacity"><b><?= $background[$i]['position'];?></b></h5>
                          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?= $background[$i]['period_start'];?> - 
                          <?php if ($background[$i]['period_finish'] == 'Current'):?>
                              <span class="w3-tag w3-teal w3-round"><?= $background[$i]['period_finish'];?></span></h6>
                          <?php else:?>
                              <?= $background[$i]['period_finish'];?></h6>
                          <?php endif;?>
                          <p><?= $background[$i]['description'];?></p>
                          <hr>
                    </div>
                <?php endfor;?>
    </div>
